...
4. Run `Build-Store.ps1` to build the combined x64 and ARM64 package for release `0.1.9`.
5. Upload `AudioStatusExtension_0.1.9.0_x64_arm64_bundle.msixupload` to the Microsoft Store submission.
